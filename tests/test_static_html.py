...
class StaticHtmlTestCase(unittest.TestCase):
    ...
    def test_lesson_plan_surfaces_and_print_layout_are_wired(self):
        ...
        self.assertIn('/static/js/lesson-plan-renderer.js?v=20260804-3', self.raw)
        self.assertIn('/static/js/lesson-plans.js?v=20260804-3', self.raw)
        ...
        self.assertIn('/static/js/lesson-plan-public.js?v=20260804-3', public_html)
